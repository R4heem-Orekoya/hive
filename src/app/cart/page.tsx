      ...
      <Wrapper>
         <div className='mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8'>
            ...
            <div className='mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16'>
               <div className={cn('lg:col-span-7', {'rounded-lg border-2 border-dashed border-zinc-200 p-12': isMounted && items.length === 0,})}>
                  ...
                  <ul className={cn({'divide-y divide-gray-200 border-b border-t border-gray-200': isMounted && items.length > 0,})}>
                     {isMounted && items.map(({ product }) => {
                        const label = PRODUCTS_CATEGORIES.find((c) => c.value === product.category)?.label
                              ...
                              <div className='ml-4 flex flex-1 flex-col justify-between sm:ml-6'>
                                 ...
                                 <div className='py-4'>
                                    <div className='flex justify-between'>
                                       <h3 className='text-sm'>
                                          <Link href={`/product/${product.id}`} className='font-medium text-zinc-700 hover:text-zinc-800'>
                                             {product.name}
                                          </Link>
                                       </h3>
                                    </div>
                                 ...
                                 <div className='mt-4 sm:mt-0 sm:pr-9 w-20'>
                                    <div className='absolute right-0 top-0'>
                                       <Button className='hover:bg-red-50' aria-label='remove product' variant='ghost'
                                          onClick={() =>
                                 ...
                                 <p className='mb-4 flex space-x-2 text-sm text-gray-700'>
               ...
               <div className='mt-16 rounded-lg bg-zinc-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8'>
                  ...
                  <div className="mt-6 space-y-4">
                     ...
                     <div className='mt-6'>
                        <Button disabled={items.length === 0 || isLoading}
                           onClick={() =>
