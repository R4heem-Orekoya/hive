   ...
   return (
      ...
      <Body style={main}>
        <Container style={container}>
          <Img
            src={`${process.env.NEXT_PUBLIC_SERVER_URL}/message-sent.png`}
            width='150'
            height='150'
            alt='DigitalHippo'
            style={logo}
...
export const PrimaryEmailAction = (props: EmailTemplateProps) => render(<EmailTemplate {...props} />, {pretty: true})
