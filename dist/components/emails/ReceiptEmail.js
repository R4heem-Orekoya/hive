...
var ReceiptEmail = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Your Hive Product Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/message-sent.png"), width: '100', height: '100', alt: 'Hive' })),
                ...
                React.createElement(components_1.Text, { style: footerCopyright },
                    "Copyright \u00A9 2023 Hive Inc. ",
                    React.createElement("br", null),
                    ' ',
                    React.createElement(components_1.Link, { href: '#' }, "All rights reserved"))))));
};
exports.ReceiptEmail = ReceiptEmail;
var ReceiptEmailHtml = function (props) { return ((0, components_1.render)(React.createElement(exports.ReceiptEmail, __assign({}, props)), { pretty: true })); };
