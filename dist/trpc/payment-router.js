...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure.input(zod_1.z.object({ productIds: zod_1.z.array(zod_1.z.string()) })).mutation(function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filteredProducts = products.filter(function (product) { return Boolean(product.priceId); });
                    ...
                    case 3:
                        ...
                        line_items.push({
                            price: "price_1PG7dWFmkNj2NFr7Fn4XwgWr",
                            quantity: 1,
                            adjustable_quantity: {
                                enabled: false
                            }
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                                success_url: "".concat(process.env.NEXT_PUBLIC_SERVER, "/thank-you?orderId=").concat(order.id),
                                cancel_url: "".concat(process.env.NEXT_PUBLIC_SERVER, "/cart"),
